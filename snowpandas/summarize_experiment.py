...
parser = argparse.ArgumentParser(description='Summarize the PySpark experiment.')
...
def main(args):
  ...
  summary_path = os.path.join(top_dir, "summary.json")
  with open(summary_path, "w") as f:
    for j in summary:
      json.dump(j, f)
      f.write("\n")

  print(f"Done! Summary available at: {summary_path}")
